    ...
    <main className="min-h-svh bg-offwhitebg py-20 px-6">
      <section>
        <div className="bg-orange p-12 rounded-t-lg">
          ...
          <a className="font-lexend text-white" href="https://www.webmotors.com.br/sedans" target="_blank">ver mais</a>
        </div>
        ...
        <div className="bg-green p-12">
          ...
          <a className="font-lexend text-white" href="https://www.webmotors.com.br/suvs" target="_blank">ver mais</a>
        </div>
        ...
        <div className="bg-dark-green p-12 rounded-b-lg">
          ...
          <a className="font-lexend text-white" href="https://www.webmotors.com.br/carros-de-luxo" target="_blank">ver mais</a>
        </div>
      </section>
    </main>
  )
